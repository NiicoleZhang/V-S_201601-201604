...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
        mylogo: 'null',
        /*
		视频加载前显示的logo文件，默认mylogo: 'logo.swf'/*tpa=http://www.yatouhome.com/templates/sm_box/images/js/logo.swf*/，不使用设置成null，即mylogo='null';
		*/
		...
		*/
        logo: 'null',
        /*
		默认右上角一直显示的logo，默认logo: 'cklogo.png'/*tpa=http://www.yatouhome.com/templates/sm_box/images/js/cklogo.png*/,不使用设置成null，即logo='null';
		*/
        pm_logo: '2,0,-100,20',
        /*
		播放器右上角的logo的位置
		...
		*/
        cpt_share: 'http://www.yatouhome.com/templates/sm_box/images/js/ckplayer/share.xml',
        /*
		分享插件调用的配置文件地址
		调用插件开始
		*/
