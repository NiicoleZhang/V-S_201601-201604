...
;(function(jQuery) {
	...
	function createHelper(settings) {
		...
		helper.body = jQuery('http://www.sxdaxin.com/wp-content/plugins/lightbox-gallery/js/div.body', helper.parent);
		helper.url = jQuery('http://www.sxdaxin.com/wp-content/plugins/lightbox-gallery/js/div.url', helper.parent);
	}
